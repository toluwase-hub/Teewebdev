      ...
      <div className="relative  ">
        ...
        <div className="contains absolute inset-0   items-center   flex justify-between    gap-20 text-white leading-relaxed">
          <div className="mt-8 reveal">
            <h1 className="text-6xl lg:text-7xl font-medium lg:font-bold">
              ABOUT TEE{" "}
            ...
            <h5 className="text-xl lg:text-2xl py-3">
              <TextType
                text={[
                  "Specializing in clean code, modern frameworks, and seamless user experiences.",
                ]}
                typingSpeed={155}
                pauseDuration={1500}
                showCursor
            ...
            <div className="flex  gap-5 mt-4 lg:mt-8">
              <button className=" p-2 px-4 py-3 rounded-md bg-[#D4A] font-bold ">
              ...
              <button className="px-4 bg-green-600 p-2 rounded-md font-bold">
                <span className="flex items-center gap-2">
                  <Link to="/Contact">
                    <span className="flex items-center gap-2">
                      {" "}
          ...
          <div className="hidden lg:flex animate-pulse">
            <img
              ...
              className="w-150 h-80 rounded-2xl object-cover"
              alt=""
            />
          </div>
        </div>
